    ...
    return (
        <div className="min-h-screen bg-bgColor relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none opacity-30">
                ...
                <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-theme/10 rounded-full blur-[150px]"></div>
                <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-cyan-theme/10 rounded-full blur-[150px]"></div>
            </div>
            ...
            <div className="fixed top-12 left-12 z-50">
                <Link href="/#projects" className="group flex items-center gap-4 text-white/50 hover:text-white transition-colors">
                    <div className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center group-hover:border-blue-theme transition-colors bg-white/5 backdrop-blur-md">
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-4 items-center">
                                {project.tech.map(t => (
                                    <span key={t} className="px-4 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] font-bold text-blue-theme uppercase tracking-widest leading-loose">
                                        {t}
                                    </span>
                                ))}
                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-24">
                    <div className="lg:col-span-2 space-y-12">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <h2 className="text-[10px] uppercase tracking-[0.5em] text-blue-theme font-bold mb-8 italic">The Vision</h2>
                    ...
                    <div className="space-y-12">
                        ...
                        >
                            <h3 className="text-[10px] uppercase tracking-[0.5em] text-blue-theme font-bold mb-8 italic">Links</h3>
                            <div className="space-y-6">
                                {project.liveHref && (
                                    <div className="flex flex-col gap-2">
                                        <span className="text-[10px] text-white/30 uppercase tracking-widest">Live Demo</span>
                                        <Link href={project.liveHref} target="_blank" className="text-white hover:text-blue-theme transition-colors font-sans text-lg border-b border-white/10 pb-2 flex items-center justify-between group">
                                            Visit Website
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <Link href={project.codeHref} target="_blank" className="text-white hover:text-blue-theme transition-colors font-sans text-lg border-b border-white/10 pb-2 flex items-center justify-between group">
                                        View on GitHub
                                        <svg className="w-4 h-4 transform group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                        </svg>
