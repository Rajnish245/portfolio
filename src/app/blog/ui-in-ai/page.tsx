  ...
  return (
    <div className='bg-bgColor min-h-screen relative overflow-hidden'>
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-teal-theme/5 rounded-full blur-[120px] animate-pulse"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[30%] h-[30%] bg-cyan-theme/5 rounded-full blur-[100px] animate-pulse delay-700"></div>
      </div>
        ...
        <article className='space-y-16 pb-24'>
          <div className='max-w-3xl space-y-6'>
            ...
            <div className="space-y-6 text-white/50 leading-relaxed font-sans text-lg">
              <p>MERN stands for <span className="text-blue-theme font-bold">MongoDB, Express.js, React, and Node.js</span>. It's a full-stack JavaScript development framework that allows developers to build complete web applications using a single programming language.</p>
              <p>The MERN stack follows a client-server architecture where <span className="text-blue-accent font-bold">React</span> handles the user interface, <span className="text-cyan-theme font-bold">Node.js</span> with <span className="text-cyan-theme font-bold">Express</span> handles the backend server and APIs, and <span className="text-blue-theme font-bold">MongoDB</span> stores the application data.</p>
            </div>
          </div>
          ...
          <div className='max-w-3xl space-y-6'>
            ...
            <div className="space-y-8 text-white/50 font-sans text-lg">
              <div className="space-y-4">
                <h3 className="text-xl text-blue-theme font-bold uppercase tracking-widest">MongoDB</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xl text-blue-theme font-bold uppercase tracking-widest">Express.js</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xl text-blue-theme font-bold uppercase tracking-widest">React</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xl text-blue-theme font-bold uppercase tracking-widest">Node.js</h3>
