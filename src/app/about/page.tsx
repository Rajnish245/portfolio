...
const AboutPage = () => {
    ...
    const skills = [
        { name: 'Languages', items: ['JavaScript', 'Python', 'C++', 'Java'] },
        { name: 'Web Tech & DB', items: ['React.js', 'Next.js', 'Node.js', 'MongoDB', 'PostgreSQL', 'Tailwind', 'REST/GraphQL'] },
        { name: 'Core CS & Theory', items: ['DSA', 'Operating Systems', 'System Design', 'Computer Networks'] },
    ]
                    ...
                    <div className="lg:col-span-7 space-y-32">
                        <section>
                            ...
                            <div className="space-y-12 text-2xl md:text-3xl lg:text-4xl text-[#F5F5F0] leading-tight font-serif font-light">
                                <p>
                                    I'm <span className="text-[#FF6B35] italic font-bold">Rajnish Kumar</span>, a Computer Science student at Lovely Professional University dedicated to crafting modern web solutions and architecting digital experiences.
                                </p>
