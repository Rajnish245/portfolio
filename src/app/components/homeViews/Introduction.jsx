  ...
  return (
    <section className='w-full py-24 md:py-48 relative overflow-hidden bg-bgColor' id='introduction'>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-blue-theme/5 rounded-full blur-[120px] animate-pulse"></div>
        <div className="absolute bottom-1/4 left-0 w-[400px] h-[400px] bg-cyan-theme/5 rounded-full blur-[100px] animate-pulse delay-1000"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-end mb-32">
          <div className="text-left">
            ...
            >
                ...
                <span className="text-blue-theme text-[10px] font-bold tracking-[0.4em] uppercase">Identity</span>
            </motion.div>
            <SplitText 
          ...
          <p className="text-white/40 text-lg md:text-xl max-w-md ml-auto text-left lg:text-right leading-relaxed border-l lg:border-l-0 lg:border-r border-blue-theme/20 pl-8 lg:pl-0 lg:pr-8">
        ...
        <div className='space-y-32'>
          <div className="w-full flex justify-end">
            <div ref={terminalRef} className={`bg-black/40 backdrop-blur-2xl rounded-2xl overflow-hidden border border-white/10 shadow-3xl transform transition-all duration-1000 ease-[0.22,1,0.36,1] w-full ${
              ...
              <div className="relative font-mono text-sm md:text-base leading-relaxed flex">
                ...
                {/* Code Content */}
                <div className="p-10 flex-1 overflow-x-auto bg-gradient-to-br from-transparent to-blue-theme/5">
                  <div className="space-y-2">
                    <p><span className="text-blue-accent/80 italic font-medium">const</span> <span className="text-white">developer</span> = <span className="text-blue-theme">{`{`}</span></p>
                    <p className="pl-6"><span className="text-white/80">name:</span> <span className="text-cyan-theme shadow-sm shadow-cyan-theme/10">'Rajnish Kumar'</span>,</p>
                    <p className="pl-6"><span className="text-white/80">role:</span> <span className="text-cyan-theme">'Full Stack Alchemist'</span>,</p>
                    <p className="pl-6"><span className="text-white/80">playground:</span> <span className="text-blue-theme">['MERN', 'AI', 'UI/UX']</span>,</p>
                    <p className="pl-6"><span className="text-white/80">philosophy:</span> <span className="text-cyan-theme">'Design for the user, build for the future'</span>,</p>
                    <p className="pl-6"><span className="text-white/80">status:</span> <span className="text-blue-accent/80">'Ready to Build'</span>,</p>
                    <p className="pl-6"><span className="text-white/80 font-medium">commit:</span> <span className="text-blue-theme">(code)</span> <span className="text-white">=&gt;{` {`}</span></p>
                    <p className="pl-12"><span className="text-blue-accent/80 italic font-medium">return</span> <span className="text-white">code.quality &gt;</span> <span className="text-cyan-theme">0.99</span> <span className="text-white">?</span> <span className="text-cyan-theme">'Success'</span> <span className="text-white">:</span> <span className="text-cyan-theme">'Refactor'</span>;</p>
                    <p className="pl-6"><span className="text-white">{`}`}</span></p>
                    <p><span className="text-blue-theme">{`}`}</span>;</p>
                    <div className="flex items-center gap-1 group/cursor mt-2">
                      <span className="text-white/40">&gt;</span>
                      <motion.div 
                        animate={{ opacity: [1, 0] }}
                        transition={{ repeat: Infinity, duration: 0.8 }}
                        className="w-2.5 h-5 bg-blue-theme shadow-lg shadow-blue-theme/50"
                      ></motion.div>
                    </div>
                  </div>
                </div>
          ...
          <div id="technical-prowess" ref={skillsRef} className={`space-y-16 transition-all duration-1000 ease-out ${
            ...
            <div className="text-center">
                ...
                />
                <div className="w-24 h-px bg-blue-theme/30 mx-auto"></div>
            </div>
...
const SkillContainer = ({ hoveredSkill, setHoveredSkill, skillsVisible, delay = 0 }) => {
  ...
  return (
    <div className="group relative w-full lg:w-1/2">
      <div className="relative bg-white/5 border border-white/10 p-10 rounded-2xl hover:border-blue-theme/30 transition-all duration-500">
        <h3 className="text-white font-serif font-bold text-2xl mb-8 flex items-center gap-4">
            <span className="w-8 h-px bg-blue-theme/50"></span>
            Languages
        </h3>
...
const FrameworkContainer = ({ hoveredSkill, setHoveredSkill, skillsVisible }) => {
  const tools = [
    ...
    { name: "PostgreSQL", img: "/POSTGRES.svg" }
  ];

  return (
    <div className="group relative w-full lg:w-1/2">
      <div className="relative bg-white/5 border border-white/10 p-10 rounded-2xl hover:border-cyan-theme/30 transition-all duration-500">
        <h3 className="text-white font-serif font-bold text-2xl mb-8 flex items-center gap-4">
            <span className="w-8 h-px bg-cyan-theme/50"></span>
            Frameworks
        </h3>
        <div className="grid grid-cols-3 md:grid-cols-4 gap-6">
...
const SoftSkillsContainer = ({ skillsVisible }) => {
  const softSkills = [
    { name: "Communication", desc: "Articulating complex technical concepts with clarity and precision." },
    { name: "Teamwork", desc: "Thriving in diverse environments and collective brainstorming." },
  ...
  return (
    <div className={`mt-24 transition-all duration-1000 delay-300 ease-out ${
      ...
      <div className="text-center mb-16">
        ...
        />
        <div className="w-24 h-px bg-cyan-theme/40 mx-auto"></div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {softSkills.map((skill, index) => (
          <motion.div 
            ...
            className="bg-white/[0.03] border border-white/10 p-10 rounded-3xl hover:border-blue-theme/50 transition-all duration-500 group relative overflow-hidden shadow-2xl hover:shadow-blue-theme/10"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-blue-theme/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
            <h4 className="text-blue-theme font-serif font-bold text-xl mb-4 relative z-10">{skill.name}</h4>
