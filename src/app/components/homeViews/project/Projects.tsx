    ...
    return (
        <section className='w-full py-48 px-6 relative bg-bgColor overflow-hidden' id='projects'>
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-1/2 left-[-10%] w-[600px] h-[600px] bg-blue-theme/5 rounded-full blur-[150px] animate-pulse"></div>
            </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                <div className="mb-48">
                    ...
                    >
                        ...
                        <span className="text-blue-theme text-[10px] font-bold tracking-[0.4em] uppercase font-sans">Featured Portfolio</span>
                    </motion.div>
                    <SplitText 
                        text="Project Works" 
                ...
                >
                    <Link href="/experience" className='group flex items-center gap-8'>
                        ...
                        <div className="w-16 h-px bg-blue-theme/30 group-hover:w-24 transition-all"></div>
                        <span className="text-white font-serif italic text-2xl group-hover:text-blue-theme transition-colors">Experience & Education</span>
                    </Link>
                </motion.div>
            </div>
        </section>
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.div 
                                ...
                                className="mt-1 text-blue-theme"
                            >
            ...
            >
                <div className={`flex flex-col ${isEven ? 'items-start' : 'items-end'}`}>
                    <div className='flex flex-wrap gap-3 mb-8'>
                        {project.tech.map(t => (
                            <span key={t} className='text-[10px] font-black uppercase tracking-[0.2em] text-blue-theme/60'>{t}</span>
                        ))}
                    </div>
                    
                    <h3 className="text-4xl md:text-6xl font-serif font-bold text-white mb-8 hover:text-blue-theme transition-colors leading-tight">
                        {project.title}
                    </h3>
                    ...
                    <div className="flex items-center gap-6">
                        <Link href={`/projects/${project.id}`} className="group flex items-center gap-4">
                            <span className="text-white text-[10px] font-bold uppercase tracking-[0.4em] group-hover:text-blue-theme transition-colors">Project Details</span>
                            <div className="w-8 h-px bg-white/20 group-hover:w-12 group-hover:bg-blue-theme transition-all"></div>
                        </Link>
                        {project.liveHref && (
                            <a href={project.liveHref} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4">
                                ...
                                <div className="p-3 rounded-full border border-white/10 group-hover:border-blue-theme/50 transition-colors">
                                    <svg className="w-4 h-4 text-white/40 group-hover:text-blue-theme" fill="none" stroke="currentColor" viewBox="0 0 24 24">
