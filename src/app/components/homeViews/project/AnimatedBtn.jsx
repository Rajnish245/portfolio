  ...
  return (
    <motion.a
        ...
        className={`relative rounded-xl text-white px-8 py-3 text-xs font-sans font-bold uppercase tracking-widest overflow-hidden transition-all duration-500 ${
          isPrimary 
            ? 'bg-gradient-to-r from-blue-theme to-cyan-theme border border-white/10 shadow-2xl shadow-blue-theme/20' 
    ...
    >
        ...
        <motion.div
            className={`absolute inset-0 ${
              isPrimary 
                ? 'bg-gradient-to-r from-cyan-theme to-blue-theme' 
