    ...
    return (
        ...
        <section className='w-full py-24 md:py-32 relative overflow-hidden'>
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute top-10 left-20 w-32 h-32 bg-cyan-theme/5 rounded-full blur-3xl animate-pulse"></div>
                <div className="absolute bottom-20 right-20 w-40 h-40 bg-blue-theme/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
            </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4">
                ...
                >
                    <div className="text-left">
                        ...
                        >
                            <AcademicCapIcon className="text-cyan-theme w-10 h-10" />
                            <div className="h-0.5 w-16 bg-cyan-theme/20"></div>
                            <span className="text-cyan-theme text-[10px] font-sans font-bold tracking-[0.4em] uppercase">Curated Credentials</span>
                        </motion.div>
                        <SplitText 
                            text="Validating Excellence" 
                            className="text-4xl md:text-7xl text-white font-serif font-bold bg-gradient-to-r from-blue-theme via-blue-accent to-cyan-theme bg-clip-text text-transparent"
                        />
                    </div>
                    <motion.p 
                        ...
                        className="text-white/40 text-lg max-w-sm lg:text-right font-sans font-medium border-r lg:border-r border-cyan-theme/30 pr-8 hidden md:block"
                    >
                ...
                >
                    <motion.h2 
                        ...
                        className="text-2xl md:text-3xl text-white/90 mb-6 font-serif font-bold border-l-4 border-blue-theme pl-6"
                    >
                        Certification
                    </motion.h2>
                    <motion.p 
                    ...
                    <div className='flex flex-col space-y-8 max-w-4xl mx-auto'>
                        {certification.map((item, index) => (
                            <motion.div 
                                ...
                                className="group"
                            >
                                <div className='relative pl-10 border-l-2 border-white/5 hover:border-blue-theme/50 transition-all duration-700'>
                                    <div className="absolute -left-[9px] top-0 w-4 h-4 bg-bgColor border-2 border-cyan-theme rounded-full group-hover:scale-125 group-hover:bg-blue-theme transition-all duration-500"></div>
                                    ...
                                    <div className='space-y-4'>
                                        <div className='flex items-center space-x-6'>
                                            ...
                                            <div>
                                                <h3 className='text-2xl font-bold text-white group-hover:text-blue-theme transition-colors duration-500 font-serif'>
                                                    {item.title}
                                                </h3>
                                        ...
                                        <div className='flex flex-wrap items-center gap-4 text-xs font-bold'>
                                            {item.id && (
                                                <span className='px-4 py-1.5 bg-cyan-theme/10 text-cyan-theme rounded-xl border border-cyan-theme/10'>
                                                    ID: {item.id}
                                                </span>
                                            )}
                                            {item.date && (
                                                <span className='px-4 py-1.5 bg-blue-theme/10 text-blue-theme rounded-xl border border-blue-theme/10'>
                                                    {item.date}
                                                </span>
                                            )}
                                            <MagneticWrapper>
                ...
                >
                        <h2 className="text-2xl md:text-3xl text-white/90 mb-6 font-serif font-bold border-l-4 border-blue-theme pl-6">
                            Certificates
                        </h2>
                    <motion.p 
                        initial={{ opacity: 0, y: 20 }}
                    ...
                    <div className='flex flex-col space-y-8 max-w-4xl mx-auto'>
                        {certificates.map((cert, index) => (
                            <motion.div 
                                ...
                                className="group"
                            >
                                <div className='relative pl-10 border-l-2 border-white/5 hover:border-teal-theme/50 transition-all duration-700'>
                                    <div className="absolute -left-[9px] top-0 w-4 h-4 bg-bgColor border-2 border-cyan-theme rounded-full group-hover:scale-125 group-hover:bg-blue-theme transition-all duration-500"></div>
                ...
                >
                    ...
                    <motion.div
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="inline-flex items-center space-x-3 bg-white/5 px-8 py-4 rounded-2xl border border-white/10 transition-all duration-500 hover:border-blue-theme/30"
                    >
                        <CheckCircleIcon className="text-blue-theme w-6 h-6" />
