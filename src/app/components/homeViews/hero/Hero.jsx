        ...
        <div className="bg-bgColor min-h-screen relative overflow-hidden flex flex-col justify-center">
            ...
            <div className="absolute inset-0 pointer-events-none">
                <motion.div
                    ...
                    className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-theme/10 rounded-full blur-[150px] animate-pulse"
                ></motion.div>
                <motion.div
                    animate={{
                    ...
                    className="absolute top-[20%] right-[-5%] w-[400px] h-[400px] bg-cyan-theme/5 rounded-full blur-[120px] animate-pulse delay-700"
                ></motion.div>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-left py-12 lg:py-24">
                        <div className="max-w-2xl">
                            <SplitText
                                text={"Hello, I am Rajnish\nKumar"}
                                className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold mb-8 justify-start bg-gradient-to-r from-blue-theme via-blue-accent to-cyan-theme bg-clip-text text-transparent italic leading-[1.3] pb-4"
                            />
                            <motion.p
                    ...
                    >
                        <div className="relative w-full max-w-[450px] aspect-square group">
                            <motion.div
                                ...
                                className="absolute inset-x-0 inset-y-0 bg-blue-theme/20 blur-3xl group-hover:bg-blue-theme/40 transition-all duration-700"
                            ></motion.div>
                            ...
                            <motion.div
                                ...
                                className="relative z-10 w-full h-full overflow-hidden border-2 border-white/10 group-hover:border-blue-theme/50 transition-colors duration-500 shadow-[0_0_50px_rgba(255,107,53,0.1)]"
                            >
                                <motion.div
                                    animate={{
                            ...
                            {/* Decorative element */}
                            <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-cyan-theme/10 rounded-full blur-xl animate-pulse"></div>
                            <div className="absolute -top-8 -left-8 w-24 h-24 bg-blue-theme/5 rounded-full blur-lg animate-pulse delay-700"></div>
                        </div>
                    </motion.div>
                </div>
            </section>
